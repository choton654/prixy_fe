...
function AgentDetail() {
    ...
    const handleKycApprovalToggle  = async (id,type,status) => {
        try {
            ...
            const response = await axios.post(updateKycAndVerifiedStatusForAgent,{ 
                id, 
                type,
    ...
    const fetchUsers = async (id) => {
        try {
            const response = await axios.post(getAgentProfileAPI,{ id }, {
                headers: {
                    'Authorization': `Bearer ${token}`
                }
            });
                ...
                <div className="container-fluid">
                    <div className="row">
                        <div className="col-sm-6">
                            <h1 className="m-0 text-dark">Manage Agent </h1>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div className="container-fluid">
                    <div className="box-main">
                        <div className="box-main-top">
                            <div className="box-main-title">Agent Details </div>
