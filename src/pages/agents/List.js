...
import { getAllAgentAPI } from '../../config';
...
class AgentList extends Component {
    ...
    fetchUsers = async () => {
        try {
            ...
            const response = await axios.get(getAllAgentAPI, {
                headers: {
                    ...
                    <div className="container-fluid">
                        <div className="row">
                            <div className="col-sm-6">
                                <h1 className="m-0 text-dark">Manage Agents</h1>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div className="container-fluid">
                        <div class="box-main">
                            <div class="box-main-top">
                                <div class="box-main-title">Agents List</div>
                                        ...
                                        <tbody>
                                            {currentUsers.map((user, index) => (
                                                <tr key={index}>
                                                    ...
                                                    <td>
                                                        <a href={`/agents/detail/${user._id}`} ><i class="fa fa-eye " aria-hidden="true"></i></a>
